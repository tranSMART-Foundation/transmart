...
/**
 *This class represents the step to load miRNA qPCR data
 */	
public class LoadData implements StepItf{
	private WorkItf workUI;
	private DataTypeItf dataType;
	public LoadData(DataTypeItf dataType){
		this.workUI=new MiRnaSeqLoadDataUI(dataType);
	...
	public String getDescription(){
		return "This step allows loading miRNA seq data from raw files and mapping files, using a Kettle job.\n"+
