...
import fr.sanofi.fcl4transmart.controllers.listeners.rnaSeqData.RnaSeqLoadDataListener;
...
/**
 *This class allows the creation of the composite to load RNAseq expression data
 */
public class LoadDataUI implements WorkItf, LoadDataUIItf{
	...
	public Composite createUI(Composite parent){
		...
		if(topNode!=null && topNode.compareTo("")!=0){
			if(this.testTm_cz && this.testTm_lz && this.testDeapp){
				button.addListener(SWT.Selection, new RnaSeqLoadDataListener(this, this.dataType));
	...
	public void setLogFile(File file){
		((RnaSeqData)this.dataType).setLogFile(file);
	}
}
