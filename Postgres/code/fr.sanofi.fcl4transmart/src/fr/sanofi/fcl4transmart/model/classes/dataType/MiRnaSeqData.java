...
import fr.sanofi.fcl4transmart.model.classes.steps.miRnaSeqData.CheckAnnotation;
import fr.sanofi.fcl4transmart.model.classes.steps.miRnaSeqData.LoadData;
import fr.sanofi.fcl4transmart.model.classes.steps.miRnaSeqData.Monitoring;
import fr.sanofi.fcl4transmart.model.classes.steps.miRnaSeqData.QualityControl;
...
public class MiRnaSeqData extends HDDData {
	
	public MiRnaSeqData(StudyItf study){
		super(study);
	}
	@Override
