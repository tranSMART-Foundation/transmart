...
import fr.sanofi.fcl4transmart.controllers.listeners.metabolomicsData.MetabolomicsLoadDataListener;
...
/**
 *This class allows the creation of the composite to load metabolomics expression data
 */
public class MetabolomicsLoadDataUI implements WorkItf, LoadDataUIItf{
	...
	boolean treeBuilt;
	public MetabolomicsLoadDataUI(DataTypeItf dataType){
	...
	public Composite createUI(Composite parent){
		...
		if(topNode!=null && topNode.compareTo("")!=0){
			if(this.testTm_cz && this.testTm_lz && this.testDeapp){
				button.addListener(SWT.Selection, new MetabolomicsLoadDataListener(this.dataType, this));
	...
	public void setLogFile(File file) {
		((MetabolomicsData)this.dataType).setLogFile(file);
	}
}
