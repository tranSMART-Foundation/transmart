...
import fr.sanofi.fcl4transmart.controllers.listeners.metabolomicsData.CheckAnnotationListener;
import fr.sanofi.fcl4transmart.controllers.listeners.metabolomicsData.MetabolomicsLoadAnnotationListener;
...
/**
 *This class allows the creation of the composite to load platform annotation data
 */
public class MetabolomicsLoadAnnotationUI implements WorkItf, LoadAnnotationUIItf{
	...
	public MetabolomicsLoadAnnotationUI(DataTypeItf dataType){
	...
	public void addLoadPart(boolean editable){
		...
		if(RetrieveData.testTm_czConnection() && RetrieveData.testTm_lzConnection() && RetrieveData.testDeappConnection()){
			loadButton.addListener(SWT.Selection, new MetabolomicsLoadAnnotationListener(this, this.dataType));
		}
		else{
	...
	public void setAnnotationLogFile(File log) {
		((MetabolomicsData)this.dataType).setAnnotationFile(log);
	}
}
