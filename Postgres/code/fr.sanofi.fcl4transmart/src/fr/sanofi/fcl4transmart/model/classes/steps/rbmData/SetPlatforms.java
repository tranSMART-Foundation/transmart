...
import fr.sanofi.fcl4transmart.model.classes.workUI.rbmData.RbmSetPlatformsUI;
...
public class SetPlatforms implements StepItf{
	...
	public SetPlatforms(DataTypeItf dataType){
		this.workUI=new RbmSetPlatformsUI(dataType);
	...
	public boolean isAvailable(){
		try{
			...
			if(((RbmData)this.dataType).getMappingFile()==null){
				return false;
			}
			return true;
		}
