...
download.file(url="http://bioconductor.org/packages/release/bioc/src/contrib/QDNAseq_1.30.0.tar.gz",
	      dest="/tmp/QDNAseq_1.30.0.tar.gz", method="internal");
install.packages("/tmp/QDNAseq_1.30.0.tar.gz",
