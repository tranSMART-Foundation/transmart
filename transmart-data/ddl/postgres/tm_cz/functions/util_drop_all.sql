...
--
CREATE FUNCTION util_drop_all(v_whattype character varying DEFAULT 'TABLE,PROCEDURE,FUNCTION,VIEW,SYNONYM'::character varying, v_dropifempty character varying DEFAULT 'Y'::character varying) RETURNS void
    LANGUAGE plpgsql
AS $$
    declare
