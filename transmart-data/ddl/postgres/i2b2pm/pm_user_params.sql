...
--
-- Name: tf_trg_pm_user_params_inc(); Type: FUNCTION; Schema: i2b2pm; Owner: -
--
CREATE FUNCTION tf_trg_pm_user_params_inc() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
begin
...
$$;
--
-- Name: trg_pm_user_params_inc; Type: TRIGGER; Schema: i2b2pm; Owner: -
--
CREATE TRIGGER trg_pm_user_params_inc BEFORE INSERT ON pm_user_params FOR EACH ROW EXECUTE PROCEDURE tf_trg_pm_user_params_inc();
--
