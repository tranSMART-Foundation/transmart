...
--
-- Name: tf_pm_project_user_params_inc(); Type: FUNCTION; Schema: i2b2pm; Owner: -
--
CREATE FUNCTION tf_pm_project_user_params_inc() RETURNS trigger
    LANGUAGE plpgsql
AS $$
begin
...
--
CREATE TRIGGER pm_project_user_params_inc BEFORE INSERT ON pm_project_user_params FOR EACH ROW EXECUTE PROCEDURE tf_pm_project_user_params_inc();
