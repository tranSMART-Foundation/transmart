...
--
-- Name: tf_pm_cell_params_inc(); Type: FUNCTION; Schema: i2b2pm; Owner: -
--
CREATE FUNCTION tf_pm_cell_params_inc() RETURNS trigger
    LANGUAGE plpgsql
AS $$
begin
...
--
-- Name: pm_cell_params_inc; Type: TRIGGER; Schema: i2b2pm; Owner: -
--
CREATE TRIGGER pm_cell_params_inc BEFORE INSERT ON pm_cell_params FOR EACH ROW EXECUTE PROCEDURE tf_pm_cell_params_inc();
--
