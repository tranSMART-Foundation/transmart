...
ALTER ROLE i2b2hive WITH SUPERUSER INHERIT NOCREATEROLE CREATEDB LOGIN NOREPLICATION PASSWORD 'md5ba6e58d9502a3d6e4408e9d0538d1632';
CREATE ROLE i2b2imdata;
ALTER ROLE i2b2imdata WITH SUPERUSER INHERIT NOCREATEROLE CREATEDB LOGIN NOREPLICATION PASSWORD 'md5ba6e58d9502a3d6e4408e9d0538d1632';
CREATE ROLE i2b2pm;
ALTER ROLE i2b2pm WITH SUPERUSER INHERIT NOCREATEROLE CREATEDB LOGIN NOREPLICATION PASSWORD 'md5ba6e58d9502a3d6e4408e9d0538d1632';
CREATE ROLE i2b2workdata;
ALTER ROLE i2b2workdata WITH SUPERUSER INHERIT NOCREATEROLE CREATEDB LOGIN NOREPLICATION PASSWORD 'md5ba6e58d9502a3d6e4408e9d0538d1632';
