--
-- Type: PROCEDURE; Owner: I2B2DEMODATA; Name: REPORT_MISSING_DIMENSION
--
  CREATE OR REPLACE PROCEDURE "I2B2DEMODATA"."REPORT_MISSING_DIMENSION" (upload_temptable_name IN VARCHAR)
IS
BEGIN
