...
"CONCEPT_CD" VARCHAR2(250 BYTE) NOT NULL ENABLE,
...
--
CREATE INDEX "I2B2DEMODATA"."FACT_NOLOB" ON "I2B2DEMODATA"."OBSERVATION_FACT" ("PATIENT_NUM", "START_DATE", "CONCEPT_CD", "ENCOUNTER_NUM",
	"INSTANCE_NUM", "NVAL_NUM", "TVAL_CHAR", VALTYPE_CD", "MODIFIER_CD", "VALUEFLAG_CD", "PROVIDER_ID", "QUANTITY_NUM", "UNITS_CD",
	"END_DATE", "LOCATION_CD", "CONFIDENCE_NUM", "UPDATE_DATE", "DOWNLOAD_DATE", "IMPORT_DATE", "SOURCESYSTEM_CD", "UPLOAD_ID")
...
--
CREATE INDEX "I2B2DEMODATA"."FACT_PATCON_DATE_PRVD_IDX" ON "I2B2DEMODATA"."OBSERVATION_FACT" ("PATIENT_NUM", "CONCEPT_CD", "START_DATE", "END_DATE",
	"ENCOUNTER_NUM", "INSTANCE_NUM", "PROVIDER_ID", "NVAL_NUM", "VALTYPE_CD")
TABLESPACE "I2B2_INDEX" ;
--
...
--
CREATE SEQUENCE  "I2B2DEMODATA"."SEQ_ENCOUNTER_NUM"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
