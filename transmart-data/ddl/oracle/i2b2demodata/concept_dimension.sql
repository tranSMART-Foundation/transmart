...
--
-- Type: INDEX; Owner: I2B2DEMODATA; Name: IDX_CONCEPT_CD
--
CREATE INDEX "I2B2DEMODATA"."IDX_CONCEPT_CD" ON "I2B2DEMODATA"."CONCEPT_DIMENSION" ("CONCEPT_CD") -- not in i2b2
TABLESPACE "I2B2_INDEX" ;
--
-- Type: INDEX; Owner: I2B2DEMODATA; Name: IDX_CONCEPT_PATH_CD
--
CREATE INDEX "I2B2DEMODATA"."IDX_CONCEPT_PATH_CD" ON "I2B2DEMODATA"."CONCEPT_DIMENSION" ("CONCEPT_PATH", "CONCEPT_CD")
TABLESPACE "I2B2_INDEX" ;
