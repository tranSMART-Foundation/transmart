...
--
CREATE SEQUENCE  "I2B2DEMODATA"."SEQ_PATIENT_NUM"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--
...
LOB ("PATIENT_BLOB") STORE AS SECUREFILE (
 ...
 NOCACHE LOGGING  NOCOMPRESS  KEEP_DUPLICATE ) ;
...
f--
-- Type: INDEX; Owner: I2B2DEMODATA; Name: PDX_IDX_DATES
--
CREATE INDEX "I2B2DEMODATA"."PDX_IDX_DATES" ON "I2B2DEMODATA"."PATIENT_DIMENSION" ("PATIENT_NUM", "VITAL_STATUS_CD", "BIRTH_DATE", "DEATH_DATE")
TABLESPACE "I2B2_INDEX" ;
--
-- Type: INDEX; Owner: I2B2DEMODATA; Name: PD_IDX_AllPatientDim
--
CREATE INDEX "I2B2DEMODATA"."PD_IDX_AllPatientDim" ON "I2B2DEMODATA"."PATIENT_DIMENSION" ("PATIENT_NUM", "VITAL_STATUS_CD",
	"BIRTH_DATE", "DEATH_DATE", "SEX_CD", "AGE_IN_YEARS_NUM",
