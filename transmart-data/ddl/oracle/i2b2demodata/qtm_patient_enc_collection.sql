--
-- Type: TABLE; Owner: I2B2DEMODATA; Name: QTM_PATIENT_ENC_COLLECTION
--
 CREATE TABLE "I2B2DEMODATA"."QTM_PATIENT_ENC_COLLECTION"
...
"ENCOUNTER_NUM" NUMBER(38,0),
 CONSTRAINT "QTM_PATIENT_ENC_COLL_PK" PRIMARY KEY ("PATIENT_ENC_COLL_ID")
 USING INDEX
 TABLESPACE "I2B2_INDEX"  ENABLE
  ) SEGMENT CREATION DEFERRED
 TABLESPACE "I2B2" ;
--
-- Type: REF_CONSTRAINT; Owner: I2B2DEMODATA; Name: QTM_FK_PESC_RI
--
ALTER TABLE "I2B2DEMODATA"."QTM_PATIENT_ENC_COLLECTION" ADD CONSTRAINT "QTM_FK_PESC_RI" FOREIGN KEY ("RESULT_INSTANCE_ID")
 REFERENCES "I2B2DEMODATA"."QTM_QUERY_RESULT_INSTANCE" ("RESULT_INSTANCE_ID") ENABLE;
--
-- Type: SEQUENCE; Owner: I2B2DEMODATA; Name: QTM_SQ_QPER_PECID
--
CREATE SEQUENCE  "I2B2DEMODATA"."QTM_SQ_QPER_PECID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
