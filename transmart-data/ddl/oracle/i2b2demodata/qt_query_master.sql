...
"PM_XML" CLOB,
 CONSTRAINT "QT_QUERY_MASTER_PK" PRIMARY KEY ("QUERY_MASTER_ID")
 USING INDEX
...
--
CREATE SEQUENCE  "I2B2DEMODATA"."QT_SQ_QM_QMID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
