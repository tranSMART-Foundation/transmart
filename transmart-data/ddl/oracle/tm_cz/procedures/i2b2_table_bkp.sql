...
BEGIN
    ...
    if tExists > 0 then
	execute immediate('drop table i2b2metadata.tm_concept_counts_bkp');
    end if;
    ...
    EXECUTE IMMEDIATE 'CREATE TABLE I2B2METADATA.TM_CONCEPT_COUNTS_BKP AS SELECT * FROM I2B2METADATA.TM_CONCEPT_COUNTS';
