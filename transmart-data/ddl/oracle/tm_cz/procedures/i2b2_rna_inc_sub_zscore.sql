...
BEGIN
    ...
    stepCt := 0;
    stepCt := stepCt + 1;
    tm_cz.cz_write_audit(jobId,databaseName,procedureName,'Starting I2B2_RNA_INC_SUB_ZSCORE',0,stepCt,'Done');
    ...
    for UpdateZscore in zscore_params
        ...
        update deapp.de_subject_rna_data d
    ...
    update deapp.de_subject_rna_data
    ...
    stepCt := stepCt + 1;
    tm_cz.cz_write_audit(jobId,databaseName,procedureName,'END of I2B2_RNA_INC_SUB_ZSCORE',0,stepCt,'Done');
    commit;
