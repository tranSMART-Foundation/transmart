...
--
-- Type: TRIGGER; Owner: DEAPP; Name: TRG_SNP_SUBJ_SORTED_DEF_ID
--
  CREATE OR REPLACE TRIGGER "DEAPP"."TRG_SNP_SUBJ_SORTED_DEF_ID"
...
/
ALTER TRIGGER "DEAPP"."TRG_SNP_SUBJ_SORTED_DEF_ID" ENABLE;
