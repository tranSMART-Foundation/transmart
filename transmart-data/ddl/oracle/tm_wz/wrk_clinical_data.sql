...
"DVAL_CHAR" VARCHAR2(500 BYTE), 
"DVAL_NUM" NUMBER(18,5),
"CATEGORY_CD" VARCHAR2(250 BYTE), 
"ETL_JOB_ID" NUMBER(22,0), 
"ETL_DATE" DATE, 
"SOURCESYSTEM_CD" VARCHAR2(200 BYTE), 
"USUBJID" VARCHAR2(200 BYTE), 
"UENCID" VARCHAR2(200 BYTE), 
...
NOCOMPRESS NOLOGGING
 TABLESPACE "TRANSMART" 
  CACHE ;
--
-- Type: INDEX; Owner: TM_WZ; Name: WRK_CD_IDX
--
CREATE INDEX "TM_WZ"."WRK_CD_IDX" ON "TM_WZ"."WRK_CLINICAL_DATA" ("DATA_TYPE", "DATA_VALUE", "VISIT_NAME", "DATA_LABEL", "CATEGORY_CD", "USUBJID")
TABLESPACE "INDX" ;
