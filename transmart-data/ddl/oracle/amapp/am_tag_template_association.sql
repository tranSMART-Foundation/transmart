...
"ID" NUMBER(*,0), 
 CONSTRAINT "AM_TAG_TEMPLATE_ASSOC_PK" PRIMARY KEY ("TAG_TEMPLATE_ID", "OBJECT_UID")
 USING INDEX
...
--
  CREATE OR REPLACE TRIGGER "AMAPP"."TRG_AM_TAG_TEMP_ASSOC_ID"
before insert on "AMAPP"."AM_TAG_TEMPLATE_ASSOCIATION"    
  for each row begin    
    if inserting then      
