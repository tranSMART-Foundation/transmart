--
-- Type: TABLE; Owner: I2B2METADATA; Name: ICD9_ICD10
--
...
-- Type: INDEX; Owner: I2B2METADATA; Name: META_BASECODE_I2B2_IDX
--
CREATE INDEX "I2B2METADATA"."META_APPL_PATH_ICD10_ICD9_IDX" ON ICD10_ICD9(M_APPLIED_PATH)
TABLESPACE "I2B2_INDEX" ; 
--
-- Type: INDEX; Owner: I2B2METADATA; Name: META_BASECODE_I2B2_IDX
--
CREATE INDEX "I2B2METADATA"."META_EXCLUSION_ICD19_ICD9_IDX" ON ICD10_ICD9(M_EXCLUSION_CD)
TABLESPACE "I2B2_INDEX" ;
--
-- Type: INDEX; Owner: I2B2METADATA; Name: META_BASECODE_I2B2_IDX
--
CREATE INDEX "I2B2METADATA"."META_HLEVEL_ICD10_ICD9_IDX" ON ICD10_ICD9(C_HLEVEL)
TABLESPACE "I2B2_INDEX" ;
--
-- Type: INDEX; Owner: I2B2METADATA; Name: META_BASECODE_I2B2_IDX
--
CREATE INDEX "I2B2METADATA"."META_SYNONYM_ICD10_ICD9_IDX" ON ICD10_ICD9(C_SYNONYM_CD)
TABLESPACE "I2B2_INDEX" ;
