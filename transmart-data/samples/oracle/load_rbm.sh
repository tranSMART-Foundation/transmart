...
groovy -cp "$LIB_CLASSPATH" TruncateLoadTable.groovy -t "TM_LZ.LT_SRC_RBM_DATA"
groovy -cp "$LIB_CLASSPATH" TruncateLoadTable.groovy -t "TM_LZ.LT_SRC_RBM_SUBJ_SAMP_MAP"
groovy -cp "$LIB_CLASSPATH" TruncateLoadTable.groovy -t "TM_LZ.LT_SRC_RBM_DISPLAY_MAPPING"
