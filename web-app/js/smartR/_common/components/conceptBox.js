...
window.smartR.components.ConceptBoxFactory = function() {

    /**
     * Create a concept component
     * @param boxId
     * @param clearId
     * @returns {Concept}
     */
    this.create = function (boxId, clearId) {

        var _concept = new Concept();

        _concept.view.boxExtJs = Ext.get(boxId);
        _concept.view.clearEl = jQuery('#' + clearId);
        _concept.view.init();
    ...
    var Concept = function () {
        ...
        // assign local model
        this.model = conceptBoxModel;

        // assign local view
        var conceptBoxView = new ConceptBoxView(this.model);
        this.view = conceptBoxView;
    }
};
