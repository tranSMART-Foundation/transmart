...
#Fast & easy adaptation of original heatmap workflow to our new backend.
main <- function(){
...
significanceMeassure <- 'variance' #settings$significanceMeassure
discardNullGenes <- 1#strtoi(settings$discardNullGenes)
maxRows <- 100#ifelse(is.null(settings$maxRows), 100, as.integer(settings$maxRows))
