...
/**
 * View that joins {@link DeXtrialNodeView} and
 * {@link DeXtrialMetadata}. It has to be done on a view because the original
 ...
 * We now use copies of these tables to keep i2b2 unchanged
 */
class DeXtrialNodeView {
    ...
    static mapping = {
        table 'deapp.de_xtrial_node_view'
        ...
        nodeType  column: 'modifier_node_type'
