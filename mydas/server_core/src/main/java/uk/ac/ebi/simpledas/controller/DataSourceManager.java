...
public class DataSourceManager {
     ...
     * @throws uk.ac.ebi.simpledas.exceptions.ConfigurationException if the XML file is badly formed or does
     ...
     * the data sources.
     * @throws uk.ac.ebi.simpledas.exceptions.ConfigurationException in the event that the loadConfiguration method has not been called
     * (a logic error) or has failed to load the expected objects.
     * @throws uk.ac.ebi.simpledas.exceptions.DataSourceException in the event that a problem
