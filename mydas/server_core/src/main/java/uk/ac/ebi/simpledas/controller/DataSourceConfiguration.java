...
import uk.ac.ebi.simpledas.datasource.AnnotationDataSource;
import uk.ac.ebi.simpledas.datasource.RangeHandlingAnnotationDataSource;
 ...
 * configuration available from this class</b> - this is handled by the SimpleDasServlet class and is
...
public class DataSourceConfiguration {
    ...
    /**
     * Package access only - instances of this class can be created by the SimpleDasServlet
