...
public class AlignObjectDetail {
	 ...
	 */
	public AlignObjectDetail(String dbSource, String property, String text) throws DataSourceException {
		super();
		if (dbSource == null || property == null || text == null ){
            throw new DataSourceException ("An attempt to instantiate a AlignObjectDetail without the minimal required mandatory values.");
        }
	...
	public void serialize(String DAS_XML_NAMESPACE, XmlSerializer serializer) throws IllegalArgumentException, IllegalStateException, IOException {
		serializer.startTag(DAS_XML_NAMESPACE,"alignObjectDetail");
		...
		serializer.endTag(DAS_XML_NAMESPACE,"alignObjectDetail");
	}
}
