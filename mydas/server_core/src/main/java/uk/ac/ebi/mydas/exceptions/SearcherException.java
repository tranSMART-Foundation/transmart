/*
 * Copyright 2010 Gustavo Salazar, EMBL-European Bioinformatics Institute
 *
 ...
 *
 * This exception should be thrown to indicate that there was an error in any of the searcher/indexing actions
 * 
 */
