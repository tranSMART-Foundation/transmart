<div id="oncoprint" style="padding-top:10px; padding-bottom:10px; padding-left:10px; border: 1px solid #CCC;">
    ...
    .onco-customize:hover { text-decoration: underline; }
		  ...
		  <table style="padding-left:13px; padding-top:5px">
		      <tbody>
			  <tr>
			      <td style="padding-right: 15px;"><span>Zoom</span>
				  <div id="zoom" style="display: inline-table;">
				      <div id="width_slider" class="ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" aria-disabled="false" style="width: 100px;">
			  ...
			  <tr>
				  ...
				  <select data-placeholder="add clinical attribute track" id="select_clinical_attributes" style="width: 350px; display: none;" class="chzn-done">
				      <option value=""></option>
				      <option>Agilent_expression</option>
				      <option>anatomic_organ_subdivision</option>
				      <option>cancer</option>
				      <option>copy-number</option>
				      <option>Disease Free (Months)</option>
				      <option>Disease Free Status</option>
				      <option>expression_subtype</option>
				      <option>Gender</option>
				      <option>histology</option>
				      <option>hypermutated</option>
				      <option>iCluster</option>
				      <option>methylation</option>
				      <option>methylation_subtype</option>
				      <option>MLH1 silencing</option>
				      <option>MSI_status</option>
				      <option>Overall Survival (Months)</option>
				      <option>Overall Survival Status</option>
				      <option>primary_tumor_pathologic_spread</option>
				      <option>sequenced</option>
				      <option>Site</option>
				      <option>tumor_stage</option>
				  </select>
				  <div id="select_clinical_attributes_chzn" class="chzn-container chzn-container-single" style="width: 240px;" title="">
				      <a href="javascript:void(0)" class="chzn-single chzn-default" tabindex="-1">
					  <span>add clinical attribute track</span>
					  <div><b>&nbsp;</b></div>
				      </a>
				      <div class="chzn-drop">
					  ...
					  <ul class="chzn-results">
					      <li id="select_clinical_attributes_chzn_o_1" class="active-result" style="">Agilent_expression</li>
					      <li id="select_clinical_attributes_chzn_o_2" class="active-result" style="">anatomic_organ_subdivision</li>
					      <li id="select_clinical_attributes_chzn_o_3" class="active-result" style="">cancer</li>
					      <li id="select_clinical_attributes_chzn_o_4" class="active-result" style="">copy-number</li>
					      <li id="select_clinical_attributes_chzn_o_5" class="active-result" style="">Disease Free (Months)</li>
					      <li id="select_clinical_attributes_chzn_o_6" class="active-result" style="">Disease Free Status</li>
					      <li id="select_clinical_attributes_chzn_o_7" class="active-result" style="">expression_subtype</li>
					      <li id="select_clinical_attributes_chzn_o_8" class="active-result" style="">Gender</li>
					      <li id="select_clinical_attributes_chzn_o_9" class="active-result" style="">histology</li>
					      <li id="select_clinical_attributes_chzn_o_10" class="active-result" style="">hypermutated</li>
					      <li id="select_clinical_attributes_chzn_o_11" class="active-result" style="">iCluster</li>
					      <li id="select_clinical_attributes_chzn_o_12" class="active-result" style="">methylation</li>
					      <li id="select_clinical_attributes_chzn_o_13" class="active-result" style="">methylation_subtype</li>
					      <li id="select_clinical_attributes_chzn_o_14" class="active-result" style="">MLH1 silencing</li>
					      <li id="select_clinical_attributes_chzn_o_15" class="active-result" style="">MSI_status</li>
					      <li id="select_clinical_attributes_chzn_o_16" class="active-result" style="">Overall Survival (Months)</li>
					      <li id="select_clinical_attributes_chzn_o_17" class="active-result" style="">Overall Survival Status</li>
					      <li id="select_clinical_attributes_chzn_o_18" class="active-result" style="">primary_tumor_pathologic_spread</li>
					      <li id="select_clinical_attributes_chzn_o_19" class="active-result" style="">sequenced</li>
					      <li id="select_clinical_attributes_chzn_o_20" class="active-result" style="">Site</li>
					      <li id="select_clinical_attributes_chzn_o_21" class="active-result" style="">tumor_stage</li>
					  </ul>
				      </div>
				  </div>
			      </td>
				  ...
				  <div id="sort_by_chzn" class="chzn-container chzn-container-single chzn-container-single-nosearch" style="width: 240px;" title="">
					  ...
					  <ul class="chzn-results">
					      <li id="sort_by_chzn_o_0" class="active-result result-selected" style="">gene data</li>
					      <li id="sort_by_chzn_o_2" class="active-result" style="">alphabetically by case id</li>
					      <li id="sort_by_chzn_o_3" class="active-result" style="">user-defined case list / default</li>
					  </ul>
				      </div>
				  </div>
			      </td>
