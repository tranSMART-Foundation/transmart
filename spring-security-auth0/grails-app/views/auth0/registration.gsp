...
<head>
	...
	<link rel="stylesheet prefetch" href="${resource(dir: 'assets/css', file: 'parsley.css')}">
	<style>
	.form-section {
		padding-left: 15px;
...
<g:if test="${useRecaptcha}"><script src='https://www.google.com/recaptcha/api.js'></script></g:if>
<script src="${resource(dir: '/js', file: 'parsley.min.js')}"></script>
<script>
$(function () {
