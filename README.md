...
More information about the plugin and installation instructions, can be found in [documention.pdf](https://github.com/evast/transmart-xnat-importer-plugin/blob/master/docs/documentation.pdf?raw=true) in the directory docs. A user-guide to import data with step-by-step instructions and screenshots can be found in the same document.
