...
<div onclick="jQuery('[name=\'regionFilter\'][value=\'gene\']').attr('checked', true);">
    ...
    <br/><br/>
    Location: 
    <g:select name='filterGeneRange' from="${ranges}" optionKey="${{it.key}}" optionValue="${{it.value}}"/>
    <g:textField name='filterGeneBasePairs' style='width: 50px'/> base pairs
</div>
<br/>
<hr/>
<br/>
...
<div onclick="jQuery('[name=\'regionFilter\'][value=\'chromosome\']').attr('checked', true);">
    ...
    <g:select name='filterChromosomeRange' from="${ranges}" optionKey="${{it.key}}" optionValue="${{it.value}}"/>
    <g:textField name='filterChromosomeBasePairs' style='width: 50px'/> base pairs
</div>
<br/>
<hr/>
<br/>
