...
<div class="search-results-table">
    <g:each in="${trials.entrySet()}" status='ti' var='trialresult'>        
		...
		<a id="toggleDetail_${experimentresult.key.id}" href="#"
		   onclick="javascript:gwasToggleDetailDiv('${trialresult.key.trialNumber}', '${createLink(controller: 'GWAS', action: 'getTrialAnalysis', params: [id: trialresult.key.id, trialNumber: trialresult.key.trialNumber, unqKey: ts])}');">
