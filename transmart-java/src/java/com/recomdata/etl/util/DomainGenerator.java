...
public class DomainGenerator {
	...
	//	generateOracleSchemaDomain();		generateMssqlDomainObj();
    ...
    public static void generateOracleSchemaDomain() {		DBConnect connect = null;
    ...
    private static String convertToClassName(String str){
        StringBuilder s = new StringBuilder();
        String[] all = str.toLowerCase().split("_");		for(String term:all){
            s.append(String.valueOf(term.charAt(0)).toUpperCase()).append(term.substring(1));
