...
public class CheckAnnotationListener implements Listener{
	private MetabolomicsLoadAnnotationUI ui;
	private String platformId;
	private boolean isLoaded;
	public CheckAnnotationListener(MetabolomicsLoadAnnotationUI ui){
		this.ui=ui;
	}
	@Override
		...
		new Thread(){
			public void run() {
				try{
				    ...
				    ResultSet rs = stmt.executeQuery("SELECT distinct platform from de_gpl_info, de_metabolite_annotation where platform='"+platformId+"' and gpl_id=platform");
