 ...
 ******************************************************************************/
package fr.sanofi.fcl4transmart.model.classes.workUI.rnaSeqData;
...
import fr.sanofi.fcl4transmart.controllers.listeners.rnaSeqData.CheckAnnotationListener;
import fr.sanofi.fcl4transmart.controllers.listeners.rnaSeqData.RnaSeqLoadAnnotationListener;
...
public class LoadAnnotationUI implements WorkItf, LoadAnnotationUIItf{
	...
	public void addLoadPart(boolean editable){
		...
		if(RetrieveData.testTm_czConnection() && RetrieveData.testTm_lzConnection() && RetrieveData.testDeappConnection()){
			loadButton.addListener(SWT.Selection, new RnaSeqLoadAnnotationListener(this, this.dataType));
		}
		else{
	...
	public void setAnnotationLogFile(File log) {
		((RnaSeqData)this.dataType).setAnnotationFile(log);
	}
}
