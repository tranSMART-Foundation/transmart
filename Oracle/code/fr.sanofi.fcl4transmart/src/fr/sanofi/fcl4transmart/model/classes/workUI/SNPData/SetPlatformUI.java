...
import fr.sanofi.fcl4transmart.controllers.listeners.snpData.SetPlatformListener;
import fr.sanofi.fcl4transmart.model.classes.dataType.SnpData;
import fr.sanofi.fcl4transmart.model.interfaces.DataTypeItf;
import fr.sanofi.fcl4transmart.model.interfaces.WorkItf;

public class SetPlatformUI implements WorkItf {
	...
	public SetPlatformUI(DataTypeItf dataType){
	...
	public Composite createUI(Composite parent){
		...
		ok.addListener(SWT.Selection, new SetPlatformListener(this.dataType, this));
