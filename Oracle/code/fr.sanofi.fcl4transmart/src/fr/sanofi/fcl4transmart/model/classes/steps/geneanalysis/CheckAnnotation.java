...
public class CheckAnnotation implements StepItf{
	...
	public String getDescription(){
		return "This step allows defining platform for an anlaysis, and checking that the platform used has annotation already loaded in the database. The identifier of the platform (e.g. 'GPL6244') has to be indicated.\n"+
