...
import fr.sanofi.fcl4transmart.controllers.listeners.snpData.SetTissueListener;
import fr.sanofi.fcl4transmart.model.classes.dataType.SnpData;
import fr.sanofi.fcl4transmart.model.interfaces.DataTypeItf;
import fr.sanofi.fcl4transmart.model.interfaces.WorkItf;

public class SetTissueUi implements WorkItf {
	...
	public SetTissueUi(DataTypeItf dataType){
	...
	public Composite createUI(Composite parent){
		...
		ok.addListener(SWT.Selection, new SetTissueListener(this.dataType, this));
