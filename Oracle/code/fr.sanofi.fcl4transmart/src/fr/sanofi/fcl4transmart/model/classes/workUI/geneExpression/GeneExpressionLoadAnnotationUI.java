...
import fr.sanofi.fcl4transmart.controllers.listeners.geneExpression.GeneExpressionLoadAnnotationListener;
 ...
 */
public class GeneExpressionLoadAnnotationUI implements WorkItf, LoadAnnotationUIItf{
	...
	public GeneExpressionLoadAnnotationUI(DataTypeItf dataType){
	...
	public void addLoadPart(boolean editable){
		...
		if(RetrieveData.testTm_czConnection() && RetrieveData.testTm_lzConnection() && RetrieveData.testDeappConnection()){
			loadButton.addListener(SWT.Selection, new GeneExpressionLoadAnnotationListener(this, this.dataType));
		}
		else{
