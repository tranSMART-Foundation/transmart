...
import fr.sanofi.fcl4transmart.model.classes.steps.qPcrMiRnaData.CheckAnnotation;
import fr.sanofi.fcl4transmart.model.classes.steps.qPcrMiRnaData.LoadData;
import fr.sanofi.fcl4transmart.model.classes.steps.qPcrMiRnaData.Monitoring;
import fr.sanofi.fcl4transmart.model.classes.steps.qPcrMiRnaData.QualityControl;
...
public class QPcrMiRnaData extends HDDData {
	public QPcrMiRnaData(StudyItf study){
		super(study);
	}
	@Override
