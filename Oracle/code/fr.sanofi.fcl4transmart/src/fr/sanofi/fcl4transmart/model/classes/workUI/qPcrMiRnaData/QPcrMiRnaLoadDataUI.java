...
import fr.sanofi.fcl4transmart.controllers.listeners.qPcrMiRnaData.QPcrMiRnaLoadDataListener;
...
/**
 *This class allows the creation of the composite to load miRNA qPCR expression data
 */
public class QPcrMiRnaLoadDataUI implements WorkItf, LoadDataUIItf{
	...
	boolean treeBuilt;
	public QPcrMiRnaLoadDataUI(DataTypeItf dataType){
	...
	public Composite createUI(Composite parent){
		...
		if(topNode!=null && topNode.compareTo("")!=0){
			if(this.testTm_cz && this.testTm_lz && this.testDeapp){
				button.addListener(SWT.Selection, new QPcrMiRnaLoadDataListener(this, this.dataType));
	...
	public void setLogFile(File file){
		((QPcrMiRnaData)this.dataType).setLogFile(file);
	}
}
