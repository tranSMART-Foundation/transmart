...
class BrowseStudy extends Page {
    ...
    static at = {
        ...
        metadataHead.text().startsWith("Study: ")
    }
...
// two of these - Analysis then Assays
// appear identical, may only have one defined
// so check for "Associated Analyses" or "Associated Assays"
