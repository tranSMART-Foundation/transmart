<div id="analysisWidget" xmlns="http://www.w3.org/1999/html">
    ...
    <asset:javascript src="gwasPlink.js"/>
    <form id="analysisForm">
        <fieldset class="inputFields">
            ...
            <p class="additionalPlinkAnalysisOptions" style="display: none;">
                ...
                <asset:image src="help/helpicon.png" alt="Help" border="0" width="18" height="18" style="vertical-align:middle;margin-left:5pt;"
		...
		<p>
                    <label for="divGroupByVariable">Covariates:
			<asset:image src="help/helpicon.png" alt="Help" border="0" width="18" height="18" style="vertical-align:middle;margin-left:5pt;"
			     title="You can drag either categorical or numerical nodes into the box below. If you drag more than one node and some subjects have data in multiple nodes the values for analysis for those subjects will be chosen at random. If the value is one of '-9', 'NULL', '' (empty string/no value) it will be converted to -9. The first value that is not converted to '-9' will be converted to 1 (control). All other values will be converted to 2 (case)." />
		    </label>
		</p>
