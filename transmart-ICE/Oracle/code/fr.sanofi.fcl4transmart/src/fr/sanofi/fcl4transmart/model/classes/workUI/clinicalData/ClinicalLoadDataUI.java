 ...
 */
public class ClinicalLoadDataUI implements WorkItf, LoadDataUIItf{
	...
	public ClinicalLoadDataUI(DataTypeItf dataType){
	...
	public void setLogFile(File file) {
		((ClinicalData)this.dataType).setLogFile(file);
	}
}
