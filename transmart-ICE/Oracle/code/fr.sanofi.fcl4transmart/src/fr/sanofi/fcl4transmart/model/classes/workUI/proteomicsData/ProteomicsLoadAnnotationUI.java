...
import fr.sanofi.fcl4transmart.controllers.listeners.proteomicsData.CheckAnnotationListener;
import fr.sanofi.fcl4transmart.controllers.listeners.proteomicsData.ProteomicsLoadAnnotationListener;
 ...
 */
public class ProteomicsLoadAnnotationUI implements WorkItf, LoadAnnotationUIItf{
	...
	public ProteomicsLoadAnnotationUI(DataTypeItf dataType){
	...
	public void addLoadPart(boolean editable){
		...
		if(RetrieveData.testTm_czConnection() && RetrieveData.testTm_lzConnection() && RetrieveData.testDeappConnection()){
			loadButton.addListener(SWT.Selection, new ProteomicsLoadAnnotationListener(this, this.dataType));
		}
		else{
	...
	public void setAnnotationLogFile(File log) {
		((ProteomicsData)this.dataType).setAnnotationFile(log);
	}
}
