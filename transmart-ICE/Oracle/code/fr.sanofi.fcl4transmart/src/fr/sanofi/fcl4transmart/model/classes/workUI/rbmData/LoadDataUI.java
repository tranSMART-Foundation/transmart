...
import fr.sanofi.fcl4transmart.controllers.listeners.rbmData.RbmLoadDataListener;
...
/**
 *This class allows the creation of the composite to load rbm expression data
 */
public class LoadDataUI implements WorkItf, LoadDataUIItf{
	...
	public Composite createUI(Composite parent){
		...
		if(topNode!=null && topNode.compareTo("")!=0){
			if(this.testTm_cz && this.testTm_lz && this.testDeapp){
				button.addListener(SWT.Selection, new RbmLoadDataListener(this, this.dataType));
	...
	public void setLogFile(File file) {
		((RbmData)this.dataType).setLogFile(file);
	}
}
