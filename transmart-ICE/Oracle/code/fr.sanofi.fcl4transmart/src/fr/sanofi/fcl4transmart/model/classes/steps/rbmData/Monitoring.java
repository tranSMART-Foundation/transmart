...
import fr.sanofi.fcl4transmart.model.classes.workUI.rbmData.MonitoringUI;
...
public class Monitoring implements StepItf{
	...
	public String getDescription(){
		return "This step allows accessing error logs for rbm data loading.\n"+
	...
	public boolean isAvailable(){
		try{
			...
			if(((RbmData)this.dataType).getLogFile()==null){
				return false;
			}
			return true;
		}
