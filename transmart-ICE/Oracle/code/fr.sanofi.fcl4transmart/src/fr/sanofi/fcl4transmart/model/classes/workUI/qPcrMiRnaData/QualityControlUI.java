...
import fr.sanofi.fcl4transmart.controllers.listeners.qPcrMiRnaData.QCListener;
...
/**
 *This class allows the creation of the composite for miRNA qPCR data quality control
 */
public class QualityControlUI implements WorkItf{
	...
	public Composite createUI(Composite parent){
		...
		transcriptNumber.setText("miRNA number: "+this.number);
		...
		transcriptLabel.setText("miRNA ID_REF: ");
	...
	public Composite createBody(String transcript){
		...
		for(File rawFile: ((QPcrMiRnaData)this.dataType).getRawFiles()){
