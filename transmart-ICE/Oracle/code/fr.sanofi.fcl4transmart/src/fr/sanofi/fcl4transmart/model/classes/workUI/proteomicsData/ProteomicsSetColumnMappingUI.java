...
import fr.sanofi.fcl4transmart.controllers.listeners.proteomicsData.ProteomicsColumnMappingListener;
import fr.sanofi.fcl4transmart.model.classes.dataType.ProteomicsData;
import fr.sanofi.fcl4transmart.model.interfaces.DataTypeItf;
import fr.sanofi.fcl4transmart.model.interfaces.WorkItf;

public class ProteomicsSetColumnMappingUI implements WorkItf{
	...
	public ProteomicsSetColumnMappingUI(DataTypeItf dataType){
	...
	public Composite createUI(Composite parent) {
		...
		Vector<File> files=((ProteomicsData)this.dataType).getRawFiles();
		for(int i=0; i<files.size(); i++){
			...
			label1.setText("Peptide identifier");
		...
		button.setText("Ok");
		button.addListener(SWT.Selection, new ProteomicsColumnMappingListener(this.dataType, this));
	...
	public void initiate(){
		...
		if(((ProteomicsData)this.dataType).getColumnMappingFile()==null){
			...
			for(File file: files){
				boolean found=false;
				try{
					BufferedReader br=new BufferedReader(new FileReader(((ProteomicsData)this.dataType).getColumnMappingFile()));
