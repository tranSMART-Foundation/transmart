			  ...
			  out.write("Filename\tCategory Code\tColumn Number\tData Label\tData Label Source\tControlled Vocab Code\n");
				try{
					...
					while ((line=br.readLine())!=null){
						...
						if(splited[3].compareTo("SUBJ_ID")==0 || splited[3].compareTo("VISIT_NAME")==0 || splited[3].compareTo("SITE_ID")==0 || line.split("\t", -1)[3].compareTo("\\")==0  || splited[3].compareTo("DATA_LABEL")==0 || splited[3].compareTo("OMIT")==0 || splited[3].compareTo("ENROLL_DATE")==0 || splited[3].compareTo("VISIT_DATE")==0){
							out.write(line+"\n");
						}
						else if(splited[4].compareTo("MIN")==0 || splited[4].compareTo("MAX")==0 || splited[4].compareTo("MEAN")==0){
							...
							out.write(splited[0]+"\t"+splited[1]+"\t"+splited[2]+"\t"+newLabel+"\t"+splited[4]+"\t"+codes.elementAt(headers.indexOf(rawFile.getName()+" - "+header))+"\n");
