 ...
 ******************************************************************************/
package fr.sanofi.fcl4transmart.model.classes.workUI.qPcrMiRnaData;
...
import fr.sanofi.fcl4transmart.controllers.listeners.qPcrMiRnaData.QPcrMirnaCheckAnnotationListener;
import fr.sanofi.fcl4transmart.controllers.listeners.qPcrMiRnaData.QPcrMirnaLoadAnnotationListener;
 ...
 */
public class LoadAnnotationUI implements WorkItf, LoadAnnotationUIItf{
	...
	public Composite createUI(Composite parent){
		...
		if(RetrieveData.testDeappConnection()){
			checkButton.addListener(SWT.Selection, new QPcrMirnaCheckAnnotationListener(this));
	...
	public void addLoadPart(boolean editable){
		...
		if(RetrieveData.testTm_czConnection() && RetrieveData.testTm_lzConnection() && RetrieveData.testDeappConnection()){
			loadButton.addListener(SWT.Selection, new QPcrMirnaLoadAnnotationListener(this, this.dataType));
		}
		else{
	...
	public void setAnnotationLogFile(File log) {
		((QPcrMiRnaData)this.dataType).setAnnotationFile(log);
	}
}
