...
import fr.sanofi.fcl4transmart.controllers.listeners.proteomicsData.ProteomicsLoadDataListener;
...
/**
 *This class allows the creation of the composite to load proteomics expression data
 */
public class ProteomicsLoadDataUI implements WorkItf, LoadDataUIItf{
	...
	boolean treeBuilt;
	public ProteomicsLoadDataUI(DataTypeItf dataType){
	...
	public Composite createUI(Composite parent){
		...
		if(topNode!=null && topNode.compareTo("")!=0){
			if(this.testTm_cz && this.testTm_lz && this.testDeapp){
				button.addListener(SWT.Selection, new ProteomicsLoadDataListener(this.dataType, this));
	...
	public void setLogFile(File file) {
		((ProteomicsData)this.dataType).setLogFile(file);
	}
}
