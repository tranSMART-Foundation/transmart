...
import fr.sanofi.fcl4transmart.controllers.listeners.snpData.SelectRawFileListener;
...
public class SelectRawFileUI implements WorkItf {
	...
	public Composite createUI(Composite parent) {
		...
		add.addListener(SWT.Selection, new SelectRawFileListener(this.dataType, this));
