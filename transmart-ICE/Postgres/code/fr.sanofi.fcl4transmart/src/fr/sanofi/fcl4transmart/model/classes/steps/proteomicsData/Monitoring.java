...
import fr.sanofi.fcl4transmart.model.classes.workUI.proteomicsData.ProteomicsMonitoringUI;
...
public class Monitoring implements StepItf{
	...
	public Monitoring(DataTypeItf dataType){
		this.workUI=new ProteomicsMonitoringUI(dataType);
	...
	public String getDescription(){
		return "This step allows accessing error logs for proteomics data loading.\n"+
