...
import fr.sanofi.fcl4transmart.controllers.listeners.HDData.SetPlatformListener;
...
public class SetPlatformsUI implements WorkItf{
	...
	protected Text appliedText;
	protected String appliedString;
	protected Vector<Text> valuesFields;
	protected Vector<String> values;
	protected Vector<Button> checkBoxs;
	protected Vector<String> samples;
	protected Listener setPlatformListener;
	...
	protected void setListeners(){
		this.setPlatformListener=new SetPlatformListener(this.dataType, this);
	}
	@Override
	public Composite createUI(Composite parent){
		...
		ok.addListener(SWT.Selection, this.setPlatformListener);
