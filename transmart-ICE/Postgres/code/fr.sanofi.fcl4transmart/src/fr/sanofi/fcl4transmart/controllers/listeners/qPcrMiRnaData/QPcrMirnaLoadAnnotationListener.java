...
import fr.sanofi.fcl4transmart.model.classes.workUI.qPcrMiRnaData.LoadAnnotationUI;
import fr.sanofi.fcl4transmart.model.interfaces.DataTypeItf;
/**
 *This class controls the platform annotation loading 
 */	
public class QPcrMirnaLoadAnnotationListener extends LoadAnnotationListener implements Listener{
	public QPcrMirnaLoadAnnotationListener(LoadAnnotationUI ui, DataTypeItf dataType){
		super(ui, dataType);
	}
	@Override
