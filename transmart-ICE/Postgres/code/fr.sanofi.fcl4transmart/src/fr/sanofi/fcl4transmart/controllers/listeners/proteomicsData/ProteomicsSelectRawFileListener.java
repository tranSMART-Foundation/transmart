...
public class ProteomicsSelectRawFileListener implements Listener {
	private ProteomicsSelectRawFilesUI ui;
	private DataTypeItf dataType;
	public ProteomicsSelectRawFileListener(ProteomicsSelectRawFilesUI ui, DataTypeItf dataType){
		this.ui=ui;
				...
				if(rawFile.isFile()){
					...
					if(!copiedRawFile.exists()){
						try {
							...
							((ProteomicsData)this.dataType).addRawFile(copiedRawFile);
