		...
		<div class="dialog">
			...
			<tbody>
				...
				<td valign="top" class="value ${hasErrors(bean:importXnatConfiguration,field:'description','errors')}">
				    <input type="text" name='description' id='description' value="${importXnatConfiguration.description}"/>
				</td>
			    </tr>
				...
				<td valign="top" class="value ${hasErrors(bean:importXnatConfiguration,field:'url','errors')}">
				    <input type="text" name='url' id='url' value="${importXnatConfiguration.url}"/>
				</td>
			    </tr>
				...
				<td valign="top" class="value ${hasErrors(bean:importXnatConfiguration,field:'username','errors')}">
				    <input type="text" name='username' id='username' value="${importXnatConfiguration.username}"/>
				</td>
			    </tr>
				...
				<td valign="top" class="value ${hasErrors(bean:importXnatConfiguration,field:'project','errors')}">
				    <input type="text" name='project' id='project' value="${importXnatConfiguration.project}"/>
				</td>
			    </tr>
				...
				<td valign="top" class="value ${hasErrors(bean:importXnatConfiguration,field:'node','errors')}">
				    <input type="text" name='node' id='node' value="${importXnatConfiguration.node}"/>
				</td>
			    </tr>
			</tbody>
		    </table>
