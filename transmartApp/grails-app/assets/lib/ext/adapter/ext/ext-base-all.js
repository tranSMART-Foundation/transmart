...
(function(){
	...
	return{
		...
		h.push({
		    id:n,fn:l,obj:o,override:m,checkReady:false
		});
		i=this.POLL_RETRYS;
		this.startInterval()
	    },
		...
		for(var p=0; p<m.length; ++p){
			...
			for(var r=0,t=u.length; r<t; ++r){
				...
				q.push({
				    type:o[this.TYPE],fn:o[this.FN],obj:o[this.OBJ],adjust:o[this.ADJ_SCOPE],index:r
				})
			    }
			}
		    }
	...
	hasDefaultHeaders:true,defaultHeaders:{},
