...
function createWorkflowStatus(parentElem, noTitleBar) {
    ...
    $j("#progress-img").attr('src', pageInfo.basePath + '/assets/spinner.gif');
...
function updateWorkflowStatus(jobStatusInfo) {
    if (jobStatusInfo != undefined) {
        ...
        if (jobStatusInfo.jobStatus == 'Error') {
            ...
            $j('#progress-img').attr('src', pageInfo.basePath + '/assets/remove.png');
            return;
        }
        ...
        if (jobStatusInfo.jobStatus == 'Completed') {
            $j('#progress-img').attr('src', pageInfo.basePath + '/assets/green_check2.png');
