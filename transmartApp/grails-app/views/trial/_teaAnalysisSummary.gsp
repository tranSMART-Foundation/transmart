...
<tr class="${(counter % 2) == 0 ? 'oddlightblue' : 'even'}">
    <td>
        <table width="100%" class="rnoborder">
                                        ...
                                        <!--  regulation status -->
                                            <g:if test="${ar.bTeaScoreCoRegulated}">
                                                <span style="font-style: italic; color: red">
                                                    <g:if test="${session.searchFilter.globalFilter.hasPathway()}">up-regulated</g:if>
						    <g:else>co-regulated</g:else>
                                                </span>
                                            </g:if>
                                            <g:else>
                                                <span style="font-style: italic; color: green">
                                                    <g:if test="${session.searchFilter.globalFilter.hasPathway()}">down-regulated</g:if>
						    <g:else>anti-regulated</g:else>
                                                </span>
                                            </g:else>
            ...
            <tr>
                <td colspan="3">
                    <div id="${bmDivId}_detail" class="gtb1" style="display: none;">
			<g:render template='/trial/analysisBiomarkerDetail' model="[analysisresult:ar]"/>
		    </div>
                </td>
            </tr>
        </table>
