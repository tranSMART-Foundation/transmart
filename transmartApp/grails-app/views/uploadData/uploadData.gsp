		...
		<div id="formPage1" class="formPage">
			...
			<tr>
				...
				<tmpl:extSearchField width="600" fieldName="study" searchAction="extSearch" searchController="experiment"
						     value="${study?.accession}" label="${study?.title}" paramString="'studyType':UPLOAD_STUDY_TYPE"/>
			...
			<table class="uploadTable">
			    <tr>
				<td width="10%">Analysis Type to Upload:<br/></td>
				<td width="90%">
				    ...
				    <g:select name='dataType' noSelection="${['null':'Select...']}"
					      ...
					      optionKey="${{it.key}}" optionValue="${{it.value}}" value="${uploadDataInstance?.dataType}"/>
