...
<div id="jubresult" style="display: block;">
	...
	<table style="padding:10px 5px 0 5px;">
            <tr>
		<td>
                    <table>
			<tr>
			    <td style="line-height: 13px;"><b>Jubilant Oncology (${searchresult?.litJubOncCount()})</b></td>
			</tr>
			<tr>
			    <td style="padding:2px 0 0 20px;">Alterations (${searchresult?.litJubOncAltCount})</td>
			</tr>
			<tr>
			    <td style="padding:2px 0 0 20px;">Inhibitors (${searchresult?.litJubOncInhCount})</td>
			</tr>
			<tr>
			    <td style="padding:2px 0 0 20px;">Interactions (${searchresult?.litJubOncIntCount})</td>
			</tr>
                    </table>
		</td>
		<td>
                    <table>
			<tr>
			    <td><b>Jubilant Asthma (${searchresult?.litJubAsthmaCount()})</b></td>
			</tr>
			<tr>
			    <td style="padding:2px 0 0 20px;">Alterations (${searchresult?.litJubAsthmaAltCount})</td>
			</tr>
			<tr>
			    <td style="padding:2px 0 0 20px;">Interactions (${searchresult?.litJubAsthmaIntCount})</td>
			</tr>
			<tr>
			    <td style="padding:2px 0 0 20px;">Protein Effects (${searchresult?.litJubAsthmaPECount})</td>
			</tr>
                    </table>
		</td>
		<td width="50%">&nbsp;</td>
			...
			<td colspan="2">
				...
				<tr>
					...
					<span style="white-space:nowrap">
						...
						&nbsp;<b>Molecule:</b>
						${jubData.reference.moleculeType}&nbsp;&nbsp;|
                                            </g:if>
                                            <g:if test="${jubData.reference.disease?.length() > 0}">
						&nbsp;<b class="filter-item filter-item-disease">Disease:</b>
						${createFilterDetailsLink(altId: jubData.reference.disease, label: jubData.reference.disease, type: "disease")}&nbsp;&nbsp;|
                                            </g:if>
                                            <g:if test="${jubData.reference.diseaseSite?.length() > 0}">
						&nbsp;<b>Disease Site:</b>
						${jubData.reference.diseaseSite}
                                            </g:if>
					</span>
                                    </td>
				</tr>
