...
<table id="configLogin"  class="detail" style="width: 100%">
    <g:tableHeaderToggle
        label="Login (${configParams.loginParams.size()})"
	divPrefix="config_login" status="open" colSpan="${3}"/>

    <tbody id="config_login_detail" style="display: block;">
        <tr>
	    <th>Parameter</th>
	    <th>Value</th>
        ...
        <g:each in="${configParams.loginParams}" var="paramData">
            <tr>
	        <td>${paramData.key}</td>
