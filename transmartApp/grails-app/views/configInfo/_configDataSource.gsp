...
<table id="configDataSource"  class="detail" style="width: 100%">
	...
	divPrefix="config_data_source" status="open" colSpan="${3}"/>

    <tbody id="config_data_source_detail" style="display: block;">
        <tr>
	    <th>Parameter</th>
	    <th>Value</th>
        ...
        <g:each in="${configParams.dataSourceParams}" var="paramData">
            <tr>
	        <td>${paramData.key}</td>
