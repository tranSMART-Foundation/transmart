...
<p>
<b>Galaxy export parameters.</b>
</p>

<table id="configGalaxy"  class="detail" style="width: 100%">
    <g:tableHeaderToggle
        label="Galaxy (${configParams.galaxyParams.size()})"
	divPrefix="config_galaxy" status="open" colSpan="${3}"/>

    <tbody id="config_galaxy_detail" style="display: block;">
        <tr>
	    <th>Parameter</th>
	    <th>Value</th>
        ...
        <g:each in="${configParams.galaxyParams}" var="paramData">
            <tr>
	        <td>${paramData.key}</td>
