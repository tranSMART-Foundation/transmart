...
<table id="configXnatView"  class="detail" style="width: 100%">
	...
	divPrefix="config_xnat_view" status="open" colSpan="${3}"/>

    <tbody id="config_xnat_view_detail" style="display: block;">
        <tr>
	    <th>Parameter</th>
	    <th>Value</th>
        ...
        <g:each in="${configParams.xnatViewParams}" var="paramData">
            <tr>
	        <td>${paramData.key}</td>
