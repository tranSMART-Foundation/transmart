		...
		<table class="detail">
			...
			<g:while test="${n < 10}">
				...
				<g:if test="${errorFlag}">
					...
					<td style="text-align: center;"><g:textField name="biomarker_${n}" value="${params['biomarker_' + n]}" maxlength="25"/></td>
				    </g:if>
				    <g:if test="${gs?.fileSchemaId==3}">
					<td style="text-align: center;"><g:textField name="probeset_${n}" value="${params['probeset_' + n]}" maxlength="25"/></td>
				    </g:if>
				    <g:if test="${gs.foldChgMetricConceptCode?.bioConceptCode!='NOT_USED'}">
					<td><g:textField name="foldChgMetric_${n}" value="${params['foldChgMetric_' + n]}" maxlength="20"/></td>
				    </g:if>
				</g:if>
				<g:else>
				    <g:if test="${gs?.fileSchemaId!=3}">
				    ...
				    <g:if test="${gs.foldChgMetricConceptCode?.bioConceptCode!='NOT_USED'}">
					<td><g:textField name="foldChgMetric_${n}" maxlength="20" /></td>
				    </g:if>
				</g:else>
