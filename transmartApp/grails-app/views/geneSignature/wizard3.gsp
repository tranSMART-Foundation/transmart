	...
	<div class="body">
		...
		<table class="detail">
			...
			<td class="value">
			    ...
			    <br/><g:textField name='normMethodOther' value="${gs.normMethodOther}" size='100%' maxlength='255'/>
			    </div>
			</td>
		    </tr>
		    <tr class="prop">
			...
			<td class="value">
				...
				<tr>
					...
					<label>Please provide 'other' detail<g:requiredIndicator/>:</label>
					<br/><g:textField name='analyticCatOther' value="${gs.analyticCatOther}"
				...
				<tr>
					...
					<label>Please provide 'other' detail<g:requiredIndicator/>:</label>
					<br/><g:textField name='analysisMethodOther' value="${gs.analysisMethodOther}"
							  size='100%' maxlength='255'/>
					</div>
				    </td>
				</tr>
		...
		<tr class="prop">
			...
			<table>
				...
				<td style="border: none;">
				    <g:select name='foldChgMetricConceptCode.id' from="${wizard.foldChgMetrics}"
		...
		<tr class="prop">
			...
			<g:if test="${wizard.wizardType==0}"><g:requiredIndicator/></g:if>
			<br/>(tab delimited text files only)
		    </td>
		    <td class="value">
			<input type="file" name="uploadFile"
			       <g:if test="${wizard.wizardType==0}">value="${gs.uploadFile}"</g:if>
			       <g:else>value=""</g:else> size="100"/>
		    </td>
		</tr>
</tbody>
</table>
