...
<html>
	...
	<div class="body">
		...
		<table class="detail">
			...
			<td class="value">
			    <g:select name='sourceConceptCode.id' from="${wizard.sources}"
			...
			<td class="value">
			    <g:select name='ownerConceptCode.id' from="${wizard.owners}"
			...
			<td class="value">
			    <table>
				<tr>
				    <td style="border: none; width; 33%;">i.e. LPS, polyIC, etc:</td>
				    <td style="border: none;">
					<g:textArea name='stimulusDescription' value="${gs.stimulusDescription}" rows='3' cols='85'/>
				    </td>
				</tr>
				<tr>
				    <td style="border: none; width; 33%;">Dose, units, and time:</td>
				    <td style="border: none;">
					<g:textField name='stimulusDosing' value="${gs.stimulusDosing}" size='67%' maxlength='255'/>
				    </td>
				</tr>
			    </table>
			</td>
			...
			<td class="value">
			    <table>
				<tr>
				    <td style="border: none; width; 33%;">Drug treatment used in assay:</td>
				    <td style="border: none;">
					<g:textArea name='treatmentDescription' value="${gs.treatmentDescription}" rows='6' cols='85'/>
				    </td>
				</tr>
				<tr>
				    <td style="border: none; width; 33%;">Dose, units, and time:</td>
				    <td style="border: none;">
					<g:textField name='treatmentDosing' value="${gs.treatmentDosing}" size='67%' maxlength='255'/>
				    </td>
				</tr>
				<tr>
				    <td style="border: none; font-weight: bold; font-style: italic;" colspan=2>OR Enter:</td>
				</tr>
				<tr>
				    <td style="border: none; width; 33%;">Compound:</td>
				    <td style="border: none;">
					<g:select name='treatmentCompound.id' from="${wizard.compounds}"
				...
				<tr>
				    <td style="border: none; width; 33%;">Protocol Number:</td>
				    <td style="border: none;">
					<g:textField name='treatmentProtocolNumber' value="${gs.treatmentProtocolNumber}" size='67%' maxlength='255'/>
				    </td>
				</tr>
			    </table>
			</td>
			...
			<td class="value">
			    <g:textField name='pmIds' value="${gs.pmIds}" size='67%' maxlength='255'/>
			</td>
		    </tr>
		    <tr class="prop">
			...
			<td class="value">
				...
				<tr>
					...
					<g:select name='speciesConceptCode.id' from="${wizard.species}"
					...
					<g:select name='speciesMouseSrcConceptCode.id' from="${wizard.mouseSources}"
					...
					<br/><g:textField name='speciesMouseDetail' value="${gs.speciesMouseDetail}"
			...
			<td class="value">
				...
				<tr>
					...
					<g:if test="${gs.experimentTypeCellLine}">
					    <g:textField name='experimentTypeCellLineText' readonly='readonly' size='80%'
							 value="${existingValues.'experimentTypeCellLine.cellLineName' + ' ('+existingValues.'experimentTypeCellLine.attcNumber'+')'}"/>
					</g:if>
					<g:else>
					    <g:textField name='experimentTypeCellLineText' readonly='readonly' size='80%'/>
					</g:else>
				...
				<tr>
				    ...
				    <td style="border: none;">
					<label>For 'in vivo', describe model<g:requiredIndicator/>:</label>
					<br/><g:textField name='experimentTypeInVivoDescr' value="${gs.experimentTypeInVivoDescr}"
							  size='100%' maxlength='255'/>
				    </td>
				</tr>
				<tr>
				    <td style="border: none;"><label>If applicable, ATCC designation:</label>
					<br/><g:textField name='experimentTypeATCCRef' value="${gs.experimentTypeATCCRef}"
							  size='100%' maxlength='255'/>
				    </td>
				</tr>
			    </table>
