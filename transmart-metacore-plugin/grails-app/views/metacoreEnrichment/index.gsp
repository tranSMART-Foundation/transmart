<div style="text-align: left; font: 12pt arial;">
	...
	<tbody>
	    <tr>
		<td><span class="AnalysisHeader">Cohorts (<i>Early Alpha version</i> - only the first cohort will be used)</span></td>
		<td align="right">&nbsp;
		    <!--
			<input type="button"
...
<form>
	...
	<tr>
	    <td colspan="4"><span class='AnalysisHeader'>Variable
		    Selection</span> <a href='JavaScript:D2H_ShowHelp(1505,helpURL,"wndExternal",CTXT_DISPLAY_FULLHELP )'>
		    <asset:image src="file:'help/helpicon_white.jpg" alt="Help" border="0" width="18pt"
