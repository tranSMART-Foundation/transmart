...
<form style="padding: 5px 5px 5px 5px" id="metacoreSettingsForm">
    ...
    <input id="radioDemo" type="radio" name="accountType" value="demo" onChange="onRadioChange()"/> No MetaCore account. 
    Run FREE enrichment on a collection of <a href="http://pathwaymaps.com/" target="_blank">publicly available maps</a> instead,
    or you can <a href="http://ip-science.thomsonreuters.com/info/insight-free-trial/" target="_blank">try MetaCore for free</a>!
    <br/><br/>
	...
	<g:if test="${systemSettingsDefined}">
	    ...
	    You will still need to know your login/password in order to open individual maps.
	    <br/><br/>
	</g:if>
